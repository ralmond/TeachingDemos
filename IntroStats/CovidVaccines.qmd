...
![Pfizer Cross Tab](../img/CovidPfizerCrossTab.png)

![Phizer X2](../img/CovidPfizerChi2.png)
```{r}
...
![Pfizer Risk Ratio](../img/CovidPfizerRisk.png)
...
![Moderna All Cases Cross Tab](../img/CovidModernaAllCrossTab.png)

![Moderna All Cases X2](../img/CovidModernaAllChi2.png)
```{r}
...
![Moderna All Cases Risk Ratio](../img/CovidModernaAllRisk.png)
...
![Moderna Severe Cases Cross Tab](../img/CovidModernaSevereCrossTab.png)

![Moderna Severe Cases X2](../img/CovidModernaSevereChi2.png)
```{r}
