...
output$tab <- renderTable(tabi(),rownames=TRUE, digits=1)
output$plot <- renderPlot(mosaicplot(tabi()),color=TRUE,
...
output$tabdd <- renderTable(tabd(),rownames=TRUE, digits=1)
output$plotd <- renderPlot(mosaicplot(tabd()),color=TRUE,
                           main="Dependent data")
```
