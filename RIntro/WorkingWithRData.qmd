...
* Vector -- ordered collection of objects of the same storage `mode`
  (`[` extract)
...
The mode function in R refers to storage modes, not the mode of a
distribution.
...
:::{.callout-db}
Notice that the list is show with
