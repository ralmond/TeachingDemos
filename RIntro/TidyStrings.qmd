...
The answer to a stat question is $t = -.876$.  Suppose that the answer
is to be counted correct:  
...
Write a regular expression that matches a character string (consisting
of numbers) which "scores" this example.
